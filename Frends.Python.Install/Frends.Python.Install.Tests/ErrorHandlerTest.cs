...
namespace Frends.Python.Install.Tests;
...
public class ErrorHandlerTest
{
    ...
    public void Should_Throw_Error_When_ThrowErrorOnFailure_Is_True()
    {
        var ex = Assert.Throws<Exception>(() =>
           Python.Install(DefaultInput(), DefaultConnection(), DefaultOptions(), CancellationToken.None));
    ...
    public void Should_Return_Failed_Result_When_ThrowErrorOnFailure_Is_False()
    {
        ...
        var result = Python.Install(DefaultInput(), DefaultConnection(), options, CancellationToken.None);
